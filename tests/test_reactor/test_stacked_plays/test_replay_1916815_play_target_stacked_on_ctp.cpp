...
// P2=yagami_black. Category: test_reactor/test_stacked_plays.
//
...
// 45-card deck from the hanab.live export (tests/replays/// 1916815.json). Suits: Tomato(0) Mahogany(1) Berry(2) Navy(3) Dark Null(4).
