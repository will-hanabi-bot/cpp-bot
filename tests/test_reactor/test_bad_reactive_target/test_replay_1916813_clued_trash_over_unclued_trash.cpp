...
// Category: test_reactor/test_bad_reactive_target.
//
...
// 45-card deck from the hanab.live export (tests/replays/// 1916813.json). Suits: Tomato(0) Mahogany(1) Berry(2) Navy(3) Dark Null(4).
